 ...
 * Josh de Leeuw
 * modified by Emiel Cracco and Mareike Westfal
 *
...
jsPsych.plugins["fixation-image-keyboard-release-with-picture-above"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('fixation-image-keyboard-release-with-picture-above', 'stimulus', 'image');

  plugin.info = {
    name: 'fixation-image-keyboard-release-with-picture-above',
    description: '',
    parameters: {
      picture: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // load
      ...
      var html = '<img src="'+trial.fixation+'" id="jspsych-fixation-image-keyboard-release-with-picture-above-stimulus" style="';
    ...
    jsPsych.pluginAPI.setTimeout(
      function() {
        ...
        // render
        document.getElementById("jspsych-fixation-image-keyboard-release-with-picture-above-stimulus").src = trial.stimulus;
        ...
        var after_response = function(info) {
          ...
          display_element.querySelector('#jspsych-fixation-image-keyboard-release-with-picture-above-stimulus').className += ' responded';
        ...
        if (trial.stimulus_duration !== null) {
          jsPsych.pluginAPI.setTimeout(function() {
            display_element.querySelector('#jspsych-fixation-image-keyboard-release-with-picture-above-stimulus').style.visibility = 'hidden';
